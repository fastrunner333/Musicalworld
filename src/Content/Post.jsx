        ...
        arr = (data.map((post, index)=>{   
                                            ...
                                            if(!post.mediatype){  
                                                    ...
                                                    <div className={styles.likedislike}>
                                                        ...
                                                        <button key={index}data-id={post._id} className={buttoncsslike} ref={(node)=>{node?likeref.current.set(index,node):likeref.current.delete(index)}} onClick={(e)=>clicklogiclike(e,i)}></button>
                                                        <span className={styles.count} ref={(node)=>{node?spanlikeref.current.set(index,node):spanlikeref.current.delete(index)}}>{likes}</span>

                                                        <button key={index}data-id={post._id} className={buttoncssdislike} ref={(node)=>{node?dislikeref.current.set(index,node):dislikeref.current.delete(index)}} onClick={(e)=>clicklogicdislike(e,i)}></button>
                                                ...
                                                return  <div key={index}  className={styles.userpostimage}>
                                                        ...
                                                        <button key={index}data-id={post._id} className={buttoncsslike} ref={(node)=>{node?likeref.current.set(index,node):likeref.current.delete(index)}} onClick={(e)=>clicklogiclike && clicklogiclike(e,i)}></button>
                                                        <span className={styles.count} ref={(node)=>{node?spanlikeref.current.set(index,node):spanlikeref.current.delete(index)}}>{likes}</span>

                                                        <button key={index}data-id={post._id} className={buttoncssdislike} ref={(node)=>{node?dislikeref.current.set(index,node):dislikeref.current.delete(index)}} onClick={(e)=>clicklogicdislike && clicklogicdislike(e,i)}></button>
                                                        <span className={styles.count} ref={(node)=>{node?spandislikeref.current.set(index,node):spandislikeref.current.delete(index)}}>{dislikes}</span>
