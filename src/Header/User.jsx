...
export function User(){
    ...
    return(
        <div style={{display:"flex", width:"17%"}}>
            ...
            <img style={{width:"7vw",height:"stretch",maxHeight:"7vh",maxWidth:"5vw"}} alt="Image"src={"https://res.cloudinary.com/dg9zjuhjn/image/upload/userpict/"+userToken+"userpic.png"} />
