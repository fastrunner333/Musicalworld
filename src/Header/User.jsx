...
export function User(){
    ...
    return(
        <div style={{display:"flex", width:"17%", justifyContent:"space-around"}}>
            ...
            <img style={{width:"7vh",height:"stretch",maxHeight:"7vh",maxWidth:"7vh"}} alt="Image"src={`https://res.cloudinary.com/ah75vno9/image/upload/userpict/${username}userpic.png?c=${date}`} />
